...
class Machine_Engine:
    ...
    def predict_rnn(self, x: np.ndarray, main_scaler, scaler_input=None) -> pd.DataFrame:
        """
    ...
    def save(self):
        save_path = f"model/{info.model_architecture}/{info.model_name}_{info.model_architecture}_{info.model_version}.pt"
