...
class Dataloader:
    ...
    def _dynamic_data_preparation(self, folder_main: str, missing_rate: float,
        ...
        self.od_matrix_train.to_csv(f"{folder_main}/train_data/at_miss{missing_rate:.1f}_train_od_matrix.csv")
        print(f"done train {missing_rate:.1f}")
        ...
        self.od_matrix_test.to_csv(f"{folder_main}/test_data/at_miss{missing_rate:.1f}_test_od_matrix.csv")
        print(f"done test {missing_rate:.1f}")
        ...
        self.od_matrix_val.to_csv(f"{folder_main}/val_data/at_miss{missing_rate:.1f}_val_od_matrix.csv")
        print(f"done validation {missing_rate:.1f}")
    ...
    def scaled_data_preparation(self, folder: str, missing_rates: list,
        ...
        for i in missing_rates:
            ...
            self.od_matrix_train_scaled.to_csv(f"{folder}/{sub_folder}/at_miss{i:.1f}_train_od_matrix.csv")
            print(f"done train {i:.1f}")
            ...
            self.od_matrix_test_scaled.to_csv(f"{folder}/{sub_folder}/at_miss{i:.1f}_test_od_matrix.csv")
            print(f"done test {i:.1f}")
            ...
            self.od_matrix_val_scaled.to_csv(f"{folder}/{sub_folder}/at_miss{i:.1f}_val_od_matrix.csv")
            print(f"done validation {i:.1f}")
