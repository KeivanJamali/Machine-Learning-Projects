...
features = ["y", "number_of_labs", "number_of_employees", "number_of_doctors", "number_of_active_beds", "markaze_behdasht", "covid", "month",
            "number_of_person_bus_inside", "number_of_travels_bus_outside"]
